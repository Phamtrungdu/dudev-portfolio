...
import './Hero.css';
// QUAN TRỌNG: Hãy đảm bảo bạn có một hình ảnh phù hợp trong thư mục assets
...
const Hero = () => {
  ...
  const toRotate = ["Network & Telecom St", "Web Developer", "UI/UX Enthusiast"];
  const period = 2000;
    ...
    <section id="home" className="hero-container">
      <div className="container hero-row">
        ...
        <div className="hero-content">
          <span className="innovate-tag">✨ Ready to Innovate</span>
...
<a
  href="/dudev-portfolio/Pham-Trung-Du.pdf"
  download
  ...
  >
    ...
    <path d="M5 21h14"></path>
          ...
          <div className="social-icons">
            ...
            <button className="button" onClick={() => window.open("https://www.instagram.com/du_0177/", "_blank")}>
            ...
            <button className="button" onClick={() => window.open("https://x.com/duit0111?s=21", "_blank")}>
            ...
            <button className="button" onClick={() => window.open("https://github.com/Phamtrungdu", "_blank")}>
              <svg viewBox="0 0 24 24" fill="currentColor" height={24} width={24} xmlns="http://www.w3.org/2000/svg" aria-hidden="true" className="w-6 h-6 text-gray-800 dark:text-white">
        ...
        <div className="hero-img-container">
          <img src={heroImage} alt="Developer" className="hero-img" />
        </div>
      </div>
